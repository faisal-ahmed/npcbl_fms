    ...
    <div class="row" style="margin-bottom: 50px;">
            <div class="col-sm-12">
                <div class="text-center status alert alert-success alert-dismissable" style="color: #000000 !important; font-size: 1.2em;">
                    <h1>এনপিসিবিএল এর ফিটনেস ম্যানেজমেন্ট সিস্টেম (এফএমএস) পোর্টাল এ আপনাকে স্বাগতম</h1>
                </div>
            </div>
        </div>
        ...
        <form class="login-form" method="post" action="<?php echo site_url('applicants/login'); ?>" id="loginForm">
            <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>User ID *</label>
                        <input type="text" name="user_id" class="form-control" required placeholder="Enter your User ID" value="<?php echo old('user_id'); ?>">
                    </div>
...
<!-- Loading Modal -->
<div id="loadingModal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; z-index:9999; background-color:rgba(255,255,255,0.8);">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        form.addEventListener('submit', async function (e) {
            ...
            showLoadingModal();
            form.submit(); // submit only after population
        });
    });
</script>
